...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/enemigosmac: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/enemigosmac ${OBJECTFILES} ${LDLIBSOPTIONS} -framework sfml-window -framework sfml-graphics -framework sfml-system

${OBJECTDIR}/Enemigo.o: Enemigo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Enemigo.o Enemigo.cpp
