...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/personaje: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/personaje ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Enemigo.o: Enemigo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Enemigo.o Enemigo.cpp
...
${OBJECTDIR}/Motor/Armas.o: Motor/Armas.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Motor/Armas.o Motor/Armas.cpp

${OBJECTDIR}/Motor/Bala.o: Motor/Bala.cpp
	${MKDIR} -p ${OBJECTDIR}/Motor
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Motor/Bala.o Motor/Bala.cpp
